...
// This particular version has been cleaned up a bit and edited for consistency by Chris Pearson
...
if (strlen($src) && file_exists($src)) {
	...
	if ($zoom_crop) {
		...
		imagecopyresampled($canvas, $image, 0, 0, 0, 0, $new_width, $new_height, $width, $height); // copy and resize part of an image with resampling
