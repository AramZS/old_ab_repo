...
function thesis_admin_setup() {
	...
	thesis_admin_styles_and_scripts();
}
...
function thesis_options_stylesheet() {
	$date_modified = filemtime(THESIS_CSS . '/options.css');
	echo '<link rel="stylesheet" href="' . THESIS_CSS_FOLDER . '/options.css?d=' . date('mdy-Gms', $date_modified) . '" type="text/css" media="screen" />' . "\n";
}
...
function thesis_options_js_deprecated(){
	$date_modified = filemtime(THESIS_SCRIPTS . '/thesis.js');
	wp_enqueue_script('thesis_js', THESIS_SCRIPTS_FOLDER . '/thesis.js?d=' . date('mdy-Gms', $date_modified) . '', 'jquery');
}
